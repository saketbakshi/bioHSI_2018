...
plot(1:10,1:10, type="n", xlim=c(550,0), ylim=c(-10,10), xlab="Geological time (Ma)", ylab="Slope of Regression Coeffecient for Extinction Estimated by Volume", main="Progression Over Time of Extinction Selectivity as Estimated by Body Size")
