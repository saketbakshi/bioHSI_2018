...
plot(1:10,1:10, type="n", xlim=c(550,0), ylim=c(-2,12), xlab="Geological time (Ma)", ylab="", main="Body Size Evolution as Divided by Respiratory Types")

title(ylab=expression(paste("Biovolume (log"[10]," cm"^3*")")), line=2.2)
